...
var vt_brancos = parseInt (prompt ("Digite o total de votos brancos:"))
var vt_nulos = parseInt (prompt ("Digite o total de votos nulos:"))
var vt_validos = parseInt (prompt ("Digite o total de votos validos :"))
